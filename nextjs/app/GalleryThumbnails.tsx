...
export default function GalleryThumbnails() {
  ...
  return (
    <div
      className="gallery-thumbnails-responsive"
      style={{ margin: "2.5rem auto 2.5rem auto" }}
    >
      {galleries.map((gallery) => {
        ...
        return (
          <Link
            ...
            style={{ textDecoration: "none", color: "inherit", width: 165, display: "block" }}
          >
            <div
              style={{
                borderRadius: 8,
            ...
            >
              <img
                ...
                alt={painting.name}
                style={{ width: "100%", height: 120, objectFit: "cover", display: "block", background: "#eee" }}
              />
